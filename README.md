...
This branch refers to the vue-formor v3 release. Check out the [v2.x branch](https://github.com/Vanilla-IceCream/vue-formor/tree/v2.x) for v2.
...
```sh
$ npm i vue-formor@3.2.1
# or
$ yarn add vue-formor@3.2.1
# or
$ pnpm i vue-formor@3.2.1
# or
$ bun add vue-formor@3.2.1
```
